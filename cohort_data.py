...
#         #print l
#         cohort_term = l[-1]
#         cohort_term = cohort_term[0:-1]
#         #print cohort_term
#         if cohort_term == 'G':
#             ghosts.append(l[0] + ' ' + l[1])
#         elif cohort_term == "Fall 2015":
#             fall_15.append(l[0] + ' ' + l[1])
#         elif cohort_term == "Spring 2016":
#             spring_16.append(l[0] + ' ' + l[1])
#         elif cohort_term == 'Summer 2016':
#             summer_16.append(l[0] + ' ' + l[1])
#         elif cohort_term == "Winter 2016":
#             winter_16.append(l[0] + ' ' + l[1])
#     # print winter_16
#     # print summer_16
#     # print fall_15
#     # print ghosts
...
#         house = l[2]
#         if house == 'Gryffindor':
#             gryffindor.append(l[1])
#         elif house == 'Hufflepuff':
#             hufflepuff.append(l[1])
#         elif house == 'Slytherin':
#             slytherin.append(l[1])
#         elif house == "Dumbledore's Army":
#             dumbledores_army.append(l[1])
#         elif house == 'Ravenclaw':
#             ravenclaw.append(l[1])
#         if term == 'G':
#             ghosts.append(l[1])
#         elif term == 'I':
#             instructors.append(l[1])
#     all_students.append(sorted(gryffindor))
#     all_students.append(sorted(slytherin))
#     all_students.append(sorted(hufflepuff))
#     #all_students.append(sorted(slytherin))
#     all_students.append(sorted(ravenclaw))
#     all_students.append(sorted(dumbledores_army))
#     #all_students.append(sorted(ravenclaw))
#     all_students.append(sorted(ghosts))
#     all_students.append(sorted(instructors))
#     return all_students
